...
namespace OpenIdDictMvcLib.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                string s1 = _sharedLocalizer["Verification code is invalid."];
                ModelState.AddModelError("Input.Code", s1);
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            string s2 = "User with ID '{UserId}' has enabled 2FA with an authenticator app.";
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(OidcIdentityUser user)
        {
