...
namespace OpenIdDictMvcLib.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<OidcIdentityUser> userManager, SignInManager<OidcIdentityUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = _sharedLocalizer["The current browser has been forgotten. When you login again from this browser you will be prompted for your 2fa code."];
