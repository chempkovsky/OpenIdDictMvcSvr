...
namespace OpenIdDictMvcLib.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public RegisterConfirmationModel(UserManager<OidcIdentityUser> userManager, IEmailSender sender, IStringLocalizer<IdentityLocalizerResource> SharedLocalizer)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string returnUrl = null)
        {
            ...
            if (user == null)
            {
                string s = _sharedLocalizer[$"Unable to load user with email '{email}'."];
                return NotFound(s);
            }
