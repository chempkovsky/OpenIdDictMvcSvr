...
namespace OpenIdDictMvcLib.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, IStringLocalizer<IdentityLocalizerResource> SharedLocalizer)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, _sharedLocalizer["Confirm your email"],
                        _sharedLocalizer[$"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>."]);
        ...
        private OidcIdentityUser CreateUser()
        {
            ...
            {
                string s = _sharedLocalizer[$"Can't create an instance of '{nameof(OidcIdentityUser)}'."] + " " +
                    _sharedLocalizer[$"Ensure that '{nameof(OidcIdentityUser)}' is not an abstract class and has a parameterless constructor, or alternatively"] + " " +
                    _sharedLocalizer[$"override the register page in /Areas/Identity/Pages/Account/Register.cshtml"];
